...
<head>
      ...
      <!-- Scripts -->
      <script type="text/javascript" src="../template/base_design/design/scripts/jquery-1.4.3.js"></script>
...
<link rel="stylesheet" href="../template/base_design/design/css/styles.css" type="text/css" media="screen, projection" />
<link rel="stylesheet" href="../template/base_design/design/css/main.css" type="text/css" media="screen, projection" />
{browser}


 <script type="text/javascript" src="../template/base_design/design/scripts/utility.js"></script>
...
<body>
    ...
    <table><tr><td width="5px">
         <a    href=""><img  height="100px" width="150px" src="../template/base_design/design/images/logo.png"/></a></td>
    ...
    <div id="isauth" style="display:none;">
      <a href="#Message" onclick="getMessage();return false;"><img src="../template/base_design/design/menu/incomming.png" width="50px" height="50px" title="Входящие сообщения" /></a>
            <a  href="#draft" onclick="doNewMessage();return false;"><img src="../template/base_design/design/menu/new_message.png" width="50px" height="50px"title="Написать новое сообщение" /></a>
              <a  href="" ><img src="../template/base_design/design/menu/edit_user.png" title="Мой профиль" width="50px" height="50px" /></a>
